...
const PRESUPUESTOS_MOCK = [
  ...
  },
  {
    ...
    inicial: "L",
    color: "#2A7D5A",
    servicio: "Instalación calefón",
    estado: "pendiente",
    monto: 32000,
    tiempoEstimado: "3–4 hs",
    garantia: 15,
  ...
  },
  {
    ...
    inicial: "D",
    color: "#8C6820",
    servicio: "Cambio de canilla",
    estado: "aceptado",
    monto: 8500,
    tiempoEstimado: "1–2 hs",
    garantia: 30,
    incluyeMateriales: true,
    vence: 0,
    fecha: "Hace 3 días",
  ...
  return (
    <div className={styles.pantalla}>
      ...
      <div className={styles.tabs}>
        {TABS.map((t) => {
          const pptosPendientes = PRESUPUESTOS_MOCK.filter(
          ...
          return (
            ...
            >
              ...
              {count > 0 && (
                <span
                  className={`${styles.tabBadge} ${tab === t.id ? styles.tabBadgeActivo : ""}`}
                  style={
                    t.destacada && tab !== t.id
                    ...
                    {(trabajo.estado === "hoy" ||
                      ...
                      <>
                        <button
                          ...
                          onClick={() =>
                            navigate(
                              `/chat-s?usuarioId=${trabajo.usuarioId}&nombre=${encodeURIComponent(trabajo.cliente)}&inicial=${trabajo.inicial}&desde=trabajos-s`,
                            )
                          }
                        >
                          💬 Chat
                        ...
                        <button
                          ...
                          onClick={() =>
                            navigate(
                              `/seguimiento-s?usuarioId=${trabajo.usuarioId}&trabajoId=${trabajo.id}`,
                            )
                          }
                        >
                          Ver trabajo →
            ...
            <div>
              ...
              >
                ...
                <div>
                  ...
                  >
                    {formPpto.cliente} · {formPpto.servicio}
                  </p>
                </div>
              </div>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setDatosPpto((p) => ({ ...p, monto: e.target.value }))
                      }
                      style={{
                        flex: 1,
                        fontSize: 22,
                ...
                >
                  ...
                  >
                    ...
                    >
                      {["Sin garantía", "7", "15", "30", "60", "90"].map(
                        (d) => (
                          <option key={d} value={d}>
                            {d === "Sin garantía" ? d : `${d} días`}
                          </option>
                        ),
                      )}
                    </select>
                    ...
                    {[true, false].map((val) => (
                      <button
                        ...
                        style={{
                          ...
                          fontWeight: 600,
                          background:
                            datosPpto.incluyeMateriales === val
                              ? "var(--tp-marron)"
                              : "rgba(61,31,31,0.06)",
                          color:
                            datosPpto.incluyeMateriales === val
                ...
                <button
                  ...
                  onClick={() => {
                    setFormPpto(null);
                    mostrarToast(
                      "✅ Presupuesto enviado a " + formPpto.cliente,
                    );
                  }}
                  style={{
                    width: "100%",
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: "var(--r-md)",
                  background: "none",
                  border: "2px dashed rgba(61,31,31,0.18)",
                  cursor: "pointer",
                  fontFamily: "var(--fuente)",
                  display: "flex",
                  alignItems: "center",
