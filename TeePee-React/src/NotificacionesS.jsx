...
const NOTIFICACIONES = {
  ...
  solucionador: [
    ...
    },
    {
      ...
      desc: "Se acreditaron $32.688 en tu cuenta por Instalación AA. Ver detalle en Ingresos.",
      tiempo: "hace 2 horas",
      leida: false,
      accion: "/ingresos",
    },
    ...
    },
    {
      ...
      desc: "Laura Pérez aceptó el ajuste de +$4.500. El acuerdo fue actualizado.",
      tiempo: "hace 1 min",
      leida: false,
    ...
    },
    {
      ...
      tipo: "pago",
      icono: "💰",
      titulo: "Pago recibido del cliente",
      desc: "Laura Pérez realizó el pago de anticipo de $6.600. Ya podés comenzar el trabajo.",
      tiempo: "hace 15 min",
      leida: false,
      accion: "/seguimiento-s?trabajoId=1",
    },
    {
      ...
      tipo: "aceptado",
      icono: "🤝",
      titulo: "Acuerdo digital firmado",
      desc: "Laura Pérez firmó el acuerdo para 'Pérdida de agua en baño'. Orden ORD-2025-0042 activa.",
      tiempo: "hace 1 hora",
      leida: true,
      accion: "/acuerdo-digital?trabajoId=1&modo=firmado",
    },
      ...
      <main className={styles.contenido}>
        ...
        {noLeidas.length > 0 && (
          <div className={styles.grupo}>
            ...
            {noLeidas.map((n) => (
              <NotifCard key={n.id} notif={n} onClick={() => handleNotif(n)} />
            ))}
          </div>
        )}
