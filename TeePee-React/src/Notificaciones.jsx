...
const NOTIFICACIONES = {
  usuario: [
    ...
    { id: 7, tipo: 'avance',       icono: '📊', titulo: 'Avance de obra reportado',          desc: 'Carlos Mendoza reportó un avance del 60% en "Pérdida de agua en baño". Revisá y aprobá para habilitar el pago.',                     tiempo: 'hace 10 min',  leida: false, accion: '/seguimiento?trabajoId=1' },
    { id: 8, tipo: 'ajuste',       icono: '📝', titulo: 'Ajuste de monto propuesto',         desc: 'Carlos Mendoza propuso un ajuste de +$4.500 por materiales adicionales en "Pérdida de agua en baño". Revisá y aceptá o rechazá.',    tiempo: 'hace 2 min',   leida: false, accion: '/seguimiento?trabajoId=1' },
  ],
  solucionador: [
    ...
    { id: 3, tipo: 'pago',         icono: '💰', titulo: 'Pago acreditado',                  desc: 'Se acreditaron $32.688 en tu cuenta (después de comisión 6%) por Instalación AA.',                                                   tiempo: 'hace 2 horas', leida: false, accion: '/ingresos' },
    { id: 4, tipo: 'avance',       icono: '✅', titulo: 'Avance aprobado por el cliente',   desc: 'Laura Pérez aprobó el 60% de avance en "Pérdida de agua en baño". El pago de $8.800 está habilitado.',                               tiempo: 'hace 5 min',   leida: false, accion: '/seguimiento-s?trabajoId=1' },
    { id: 5, tipo: 'ajuste',       icono: '📝', titulo: 'Ajuste de monto aceptado',         desc: 'Laura Pérez aceptó el ajuste de +$4.500. El acuerdo digital fue actualizado.',                                                        tiempo: 'hace 1 min',   leida: false, accion: '/acuerdo-digital?trabajoId=1&modo=firmado' },
    { id: 6, tipo: 'calificacion', icono: '⭐', titulo: 'Nueva calificación recibida',      desc: 'Ana Gómez te calificó con 5 estrellas: "Excelente trabajo, muy puntual."',                                                            tiempo: 'ayer',         leida: true,  accion: '/perfil-solucionador' },
    { id: 7, tipo: 'recordatorio', icono: '📅', titulo: 'Trabajo mañana a las 9:00',        desc: 'Recordatorio: Tablero eléctrico en Av. Mitre 1234. Cliente: Martín García.',                                                          tiempo: 'ayer',         leida: true,  accion: '/agenda' },
    { id: 8, tipo: 'solicitud',    icono: '🔔', titulo: 'Solicitud urgente cerca tuyo',     desc: 'Roberto Silva necesita un Plomero URGENTE. A solo 1.2 km de tu ubicación.',                                                           tiempo: 'hace 2 días',  leida: true,  accion: '/home-solucionador' },
  ],
}

// Colores por tipo como variables CSS — evita inline styles en cada card
const COLORES_TIPO = {
