  ...
  usuario: [
    {
      ...
      desc: 'Carlos Mendoza te envió un presupuesto de $22.000 para Pérdida de agua.',
      tiempo: 'hace 5 min',
      leida: false,
      accion: '/presupuestos',
    },
    {
      ...
      tipo: 'en-camino',
      icono: '🚗',
      titulo: 'Solucionador en camino',
      desc: 'Juan Ledesma está en camino a tu domicilio. Llega en aprox. 15 min.',
      tiempo: 'hace 20 min',
      leida: false,
      accion: '/seguimiento',
    },
    {
      ...
      desc: 'Roberto Flores marcó como completado "Instalación de AA". Confirmá para liberar el pago.',
      tiempo: 'hace 1 hora',
      leida: false,
      accion: '/seguimiento',
    },
    {
      ...
      desc: 'Se acreditaron $22.000 en tu MercadoPago por la cancelación del servicio.',
      tiempo: 'ayer',
      leida: true,
      accion: '/trabajos',
    },
    {
      ...
      desc: 'Ya pasaron 24 hs. ¿Cómo estuvo el trabajo de Miguel Saracho?',
      tiempo: 'ayer',
      leida: true,
      accion: '/calificacion',
    },
    {
      ...
      desc: 'El presupuesto de Roberto Flores vence en 24 hs. ¡No lo dejes pasar!',
      tiempo: 'hace 2 días',
      leida: true,
      accion: '/presupuestos',
    },
    {
      ...
      tipo: 'avance',
      icono: '📊',
      titulo: 'Avance de obra reportado',
      desc: 'Carlos Mendoza reportó un avance del 60% en "Pérdida de agua en baño". Revisá y aprobá para habilitar el pago.',
      tiempo: 'hace 10 min',
      leida: false,
      accion: '/seguimiento?trabajoId=1',
    },
    {
      id: 8,
      tipo: 'ajuste',
      icono: '📝',
      titulo: 'Ajuste de monto propuesto',
      desc: 'Carlos Mendoza propuso un ajuste de +$4.500 por materiales adicionales en "Pérdida de agua en baño". Revisá y aceptá o rechazá.',
      tiempo: 'hace 2 min',
      leida: false,
      accion: '/seguimiento?trabajoId=1',
    },
  ...
  solucionador: [
    {
      ...
      desc: 'Laura Pérez necesita un Plomero — Pérdida de agua en baño. A 2.3 km.',
      tiempo: 'hace 3 min',
      leida: false,
      accion: '/home-solucionador',
    },
    {
      id: 2,
      tipo: 'aceptado',
      ...
      desc: 'Martín García aceptó tu presupuesto de $35.200 para Tablero eléctrico.',
      tiempo: 'hace 30 min',
      leida: false,
      accion: '/chat',
    },
    {
      ...
      desc: 'Se acreditaron $32.688 en tu cuenta (después de comisión 6%) por Instalación AA.',
      tiempo: 'hace 2 horas',
      leida: false,
      accion: '/ingresos',
    },
    {
      ...
      tipo: 'avance',
      icono: '✅',
      titulo: 'Avance aprobado por el cliente',
      desc: 'Laura Pérez aprobó el 60% de avance en "Pérdida de agua en baño". El pago de $8.800 está habilitado.',
      tiempo: 'hace 5 min',
      leida: false,
      accion: '/seguimiento-s?trabajoId=1',
    },
    {
      id: 5,
      tipo: 'ajuste',
      icono: '📝',
      titulo: 'Ajuste de monto aceptado',
      desc: 'Laura Pérez aceptó el ajuste de +$4.500. El acuerdo digital fue actualizado.',
      tiempo: 'hace 1 min',
      leida: false,
      accion: '/acuerdo-digital?trabajoId=1&modo=firmado',
    },
    {
      id: 4,
      tipo: 'calificacion',
      ...
      desc: 'Ana Gómez te calificó con 5 estrellas: "Excelente trabajo, muy puntual."',
      tiempo: 'ayer',
      leida: true,
      accion: '/perfil-solucionador',
    },
    {
      id: 5,
      tipo: 'recordatorio',
      icono: '📅',
      titulo: 'Trabajo mañana a las 9:00',
      desc: 'Recordatorio: Tablero eléctrico en Av. Mitre 1234. Cliente: Martín García.',
      tiempo: 'ayer',
      leida: true,
      accion: '/agenda',
    },
    {
      ...
      tipo: 'solicitud',
      icono: '🔔',
      titulo: 'Solicitud urgente cerca tuyo',
      desc: 'Roberto Silva necesita un Plomero URGENTE. A solo 1.2 km de tu ubicación.',
      tiempo: 'hace 2 días',
      leida: true,
      accion: '/home-solucionador',
    },
    ...
    <div className={styles.pantalla}>
      ...
      <header className={styles.header}>
        ...
        <span className={styles.headerTitulo}>
          Notificaciones
          {sinLeer > 0 && (
            <span className={styles.headerBadge}>{sinLeer}</span>
          )}
        </span>
        {sinLeer > 0 && (
          <button
