    ...
    >
      ...
      >
        ...
        <button
          ...
          onClick={() =>
            navigate(
              `/chat-s?usuarioId=${trabajoData.usuarioId}&nombre=${encodeURIComponent(t.cliente.nombre)}&inicial=${t.cliente.inicial}&desde=seguimiento-s&trabajoId=${trabajoData.id}`,
            )
          }
          style={{
            display: "flex",
      ...
      <div style={{ padding: "14px 16px 90px" }}>
        ...
        >
          ...
          <button
            ...
            onClick={() =>
              navigate(
                `/acuerdo-digital?desde=seguimiento-s&trabajoId=${trabajoData.id}`,
              )
            }
            style={{
              fontSize: 11,
        ...
        >
            ...
            {avanceActual > avanceAprobado && (
              <div
                style={{
                  ...
                  background:
                    "repeating-linear-gradient(45deg, rgba(184,64,48,0.25), rgba(184,64,48,0.25) 4px, rgba(184,64,48,0.10) 4px, rgba(184,64,48,0.10) 8px)",
                }}
              />
            )}
          </div>
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            ...
            >
              ...
              {avanceActual > avanceAprobado && (
                <span style={{ color: "var(--tp-rojo)", marginLeft: 8 }}>
                  · Enviado: {avanceActual}%
                </span>
              )}
            </p>
            <p
          ...
          <div style={{ marginTop: 14 }}>
            ...
            >
              <span style={{ fontSize: 10, color: "var(--tp-marron-suave)" }}>
                {avanceAprobado}%
              </span>
              <span style={{ fontSize: 10, color: "var(--tp-marron-suave)" }}>
                100%
              ...
              >
                <div>
                  ...
                  >
                    ...
                    {avanceActual - avanceAprobado}% del total
                  </p>
                </div>
                <p
                  style={{
          ...
          <button
            ...
            onClick={
              avanceActual === 100
                ? () =>
                    mostrarToast(
                      "¡Marcaste el trabajo como terminado! El cliente recibirá una notificación.",
                    )
                : enviarAvance
            }
            ...
            <div style={{ flex: 1, textAlign: "left" }}>
              ...
              <div style={{ display: "flex", alignItems: "baseline", gap: 8 }}>
                ...
                <span style={{ fontSize: 11, color: "var(--tp-marron-suave)" }}>
                  cobrado de ${t.monto.toLocaleString("es-AR")} · {pctCobrado}%
                </span>
              </div>
            </div>
            <div
      ...
      {modalAjuste && (
        ...
        >
          ...
          >
            ...
            >
              El cliente recibirá una notificación y deberá aceptar el nuevo
            ...
            >
              ...
              <textarea
                placeholder="Ej: Materiales adicionales por rotura oculta..."
                value={ajusteDesc}
            ...
            <button
              ...
              onClick={() => {
                ...
                mostrarToast("✅ Ajuste enviado al cliente para aprobación");
              }}
              style={{
                width: "100%",
                padding: 14,
