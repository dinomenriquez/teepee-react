...
export default function AcuerdoDigital() {
  ...
  const a = {
    ...
    solucionador: {
      nombre: solData.nombre,
      oficio: solData.oficio,
      nivel: solData.nivel,
      reputacion: solData.reputacion,
      inicial: solData.inicial,
      color: solData.color,
    },
    usuario: { nombre: usuData.nombre, inicial: usuData.inicial },
    trabajo: {
      descripcion: trabajoData.titulo,
      detalle: trabajoData.descripcion,
      categoria: trabajoData.categoria,
      direccion: trabajoData.direccion,
      fechaEstimada: trabajoData.fechaEstimada,
    },
  ...
  // Ajustes aprobados incorporados al acuerdo (mock)
  const ajustesAprobados = modoFirmado
    ? [
        {
          ...
          monto: 4500,
          descripcion:
            "Materiales adicionales: sellador especial y cañería de repuesto no contemplada en el presupuesto original.",
    ...
    : [];
  const montoTotal =
    a.monto + ajustesAprobados.reduce((s, aj) => s + aj.monto, 0);
    ...
    return (
      ...
      >
        <div style={{ textAlign: "center", maxWidth: 320 }}>
          ...
          >
            Orden <strong style={{ color: "var(--tp-crema)" }}>{a.id}</strong>{" "}
            generada.
          </p>
          <p
            style={{
          ...
          >
            {a.solucionador.nombre} fue notificado. El trabajo está activo.
          </p>
          ...
          {a.formaCobro === "total" && (
            ...
            >
              ...
              >
                Pago 100% al finalizar el trabajo
              </p>
            </div>
          )}
          <button
            type="button"
            onClick={() => navigate(`/seguimiento?trabajoId=${trabajoId}`)}
            style={{
              width: "100%",
              padding: 16,
              borderRadius: "var(--r-md)",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          type="button"
          onClick={() => mostrarToast("PDF disponible en la app móvil")}
          style={{
            display: "flex",
            alignItems: "center",
            gap: 5,
      ...
      <div style={{ padding: "16px 16px 0" }}>
        {/* Partes */}
        <div
          style={{ ...sCard, display: "flex", gap: 12, alignItems: "center" }}
        >
          <div style={{ flex: 1 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              <div
                style={{
                  ...
                  height: 36,
                  borderRadius: "50%",
                  background: a.solucionador.color,
                  color: "white",
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
              ...
              <div>
                ...
                >
                  {a.solucionador.oficio} · ⭐ {a.solucionador.reputacion} ·{" "}
                  {a.solucionador.nivel}
                </p>
              </div>
            </div>
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
            ...
            <div style={{ display: "flex", gap: 8 }}>
              ...
              <span style={{ fontSize: 12, color: "var(--tp-marron-suave)" }}>
                {a.trabajo.fechaEstimada}
              </span>
            </div>
            <div style={{ display: "flex", gap: 8 }}>
              <span style={{ fontSize: 14 }}>🔧</span>
              <span style={{ fontSize: 12, color: "var(--tp-marron-suave)" }}>
                Materiales {a.incluyeMateriales ? "incluidos" : "no incluidos"}
              </span>
            </div>
          </div>
        </div>
        ...
        <div style={{ ...sCard, background: "var(--tp-marron)" }}>
          <p style={{ ...sLabel, color: "rgba(240,234,214,0.50)" }}>
          ...
          {ajustesAprobados.length > 0 && (
            ...
            >
              {"$"}
              {a.monto.toLocaleString("es-AR")} original +{" "}
              {ajustesAprobados.length} ajuste
              {ajustesAprobados.length > 1 ? "s" : ""} aprobado
              {ajustesAprobados.length > 1 ? "s" : ""}
            </p>
          )}
          <p
            style={{ fontSize: 11, color: "rgba(240,234,214,0.45)", margin: 0 }}
          >
            {a.formaCobro === "total"
              ? "Pago único al finalizar"
              : `En ${a.etapas.length} etapas según avance`}
          </p>
        </div>
        ...
        <div style={sCard}>
          ...
          {a.formaCobro === "total" ? (
            ...
            >
              <CheckCircle
                size={18}
                style={{ color: "var(--verde)", flexShrink: 0 }}
              />
              <div>
                <p
                  style={{
                ...
                >
                  Se habilita cuando confirmás que el trabajo está terminado
                </p>
              </div>
            </div>
          ) : (
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              {a.etapas.map((e, i) => (
                <div
                  ...
                  style={{
                    borderRadius: "var(--r-md)",
                    overflow: "hidden",
                    border: `1px solid ${i === 0 ? "rgba(184,64,48,0.25)" : "rgba(61,31,31,0.08)"}`,
                  }}
                >
                  <button
                    type="button"
                  ...
                  >
                    <div
                      style={{
                        ...
                        fontWeight: 900,
                        background:
                          i === 0 ? "var(--tp-rojo)" : "rgba(61,31,31,0.08)",
                        color: i === 0 ? "white" : "var(--tp-marron-suave)",
                      }}
                    >
                      {e.pct}%
                    </div>
                  ...
                  {expandido === i && (
                    <div
                      style={{
                        ...
                        borderTop: "1px solid rgba(61,31,31,0.06)",
                      }}
                    >
                      <p
                        style={{
              ...
              >
                ...
                >
                  Total en {a.etapas.length} pagos
                </span>
                <span
                  style={{
                    fontSize: 13,
        ...
        {/* Ajustes aprobados incorporados al acuerdo */}
        {ajustesAprobados.length > 0 && (
          <div style={sCard}>
            <p style={sLabel}>Ajustes de monto aprobados</p>
            {ajustesAprobados.map((aj, i) => (
              <div
                ...
                style={{
                  ...
                  border: "1px solid rgba(42,125,90,0.18)",
                  marginBottom: i < ajustesAprobados.length - 1 ? 8 : 0,
                }}
              >
                <div
                  style={{
        ...
        >
          ...
          >
            ...
            de TeePee. Este documento tiene validez como acuerdo digital entre
            las partes.
          </p>
        </div>
